...
List<Widget> fullList = [
  new Crypto("Slug",Colors.black12,0)
];
...
class FavCrypto extends StatefulWidget{
  ...
  FavCrypto(this.slug,this.index,this.friendIndex);
        ...
        child: new FlatButton(
          ...
          child: new Row(
            children: <Widget>[
              ...
              new Expanded(child: new Text("Bitcoin",style: new TextStyle(fontSize:25.0))),
...
class Crypto extends StatefulWidget{
  ...
  Crypto(this.slug,this.color,this.index);
        ...
        child: new FlatButton(
            ...
            onPressed: (){
              ...
              if(widget.color==Colors.black26){
                favList.add(new FavCrypto(widget.slug, favList.length,widget.index));
